 ...
 * @author juanc
 */
public class VentanaCap4Ejer10 extends javax.swing.JFrame {

    /**
     * Creates new form VentanaCap4Ejer10
     */
    public VentanaCap4Ejer10() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtNuminscrip = new javax.swing.JTextField();
        ...
        jLabel1.setText("N° de Inscripción");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtNuminscrip, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(txtNuminscrip, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
    ...
    private void bntConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntConsultarActionPerformed
        // Codigo de boton btnConsulta:
        
        double NI,PAT,EST,PAGMAT; //N°Inscripión,Patrimonio,Estrato
        String NOM; //Nombre
        NI = Double.parseDouble(txtNuminscrip.getText());
        NOM = txtNombre.getText();
        PAT = Double.parseDouble(txtPatrimonio.getText());
        EST = Double.parseDouble(txtEstrato.getText());
        PAGMAT = PatrimonioMayor.patrimonio_mayor(PAT, EST);
        txtResult.setText(String.valueOf("EL ESTUDIANTE CON NUMERO DE INSCRIPCION " + NI + " Y NOMBRE " + NOM + " DEBE PAGAR: $ " + PAGMAT));
    }//GEN-LAST:event_bntConsultarActionPerformed

    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        // Codigo del Boton btnBorrar:
        txtNuminscrip.setText("");
        txtNombre.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaCap4Ejer10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaCap4Ejer10().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtNuminscrip;
